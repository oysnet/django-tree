...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:tree.6e0165542327.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},members:{__qx:null,__qw:null,__qv:null,_contextMenu:null,selectItem:function(bx){var by=null;
...
this.__qv[this.getNode().getPk()][bR].item=bT;
...
}this.__qv[this.getNode().getPk()][cb]={uploader:bW,item:null,progress:new tree.ui.Progress(bW)};
bX+=ca.size;
...
}else if([b,J].indexOf(ch)!==-1){this.__qy(ce,cf);
}},this,this.getNode(),cb,bW),this);
bW.start();
}return false;
},__qy:function(cl,cm){this.__qv[cl.getPk()][cm].uploader.dispose();
delete this.__qv[cl.getPk()][cm];
},updateItems:function(){var cq=this.getItems();
this.itemCount=cq!==null?cq.length:0;
var cp=this.__qx.getPane();
var cn=this.__qx.getPaneSize()!==null?this.__qx.getPaneSize().width:this.getWidth();
...
cp.fullUpdate();
},_applyItems:function(cs,ct){if(this.getNode()!==null){var cu=this.__qv[this.getNode().getPk()];

if(typeof (cu)!==n){for(var cv in cu){if(cu[cv].uploader.getState()==M){this.getItems().push(cu[cv].item);
}}}}this.manager.clearSelection();
this.updateItems();
this.fireEvent(D);
},_applyNode:function(cw,cx){if(cx!==null){var cy=this.__qv[cx.getPk()];

if(typeof (cy)!==n){for(var cz in cy){cy[cz].progress.dispose();
cy[cz].progress=null;
}}}
if(cw!==null){this.refreshNodeItems();
var cy=this.__qv[cw.getPk()];

if(typeof (cy)!==n){for(cz in cy){var cA=this.__qv[this.getNode().getPk()][cz];
...
if(typeof (cI.uploadId)===n){cI.path=this.__qw.getCurrentPath()+P+cI.itemPk;
}}
if(cI===null){return;
}
...
},_onLayerUpdated:function(){if(this.getNode()!==null){var cS=this.__qv[this.getNode().getPk()];
